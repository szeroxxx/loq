...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("wallet_scanner1.log", encoding='utf-8'),
...
def check_balance_from_private_key():
    # 11
    starting_key = int("0xa32bd1dfb632bd1dfb632bd1dfb632bd1dfb632bd1dfb632bd1dfb632bd1dfbc", 16)
    ending_key = int("0xa335a8f9b2335a8f9b2335a8f9b2335a8f9b2335a8f9b2335a8f9b2335a8f9b7", 16)

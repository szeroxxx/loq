...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("wallet_scanner4.log", encoding='utf-8'),
...
def get_token_balance_with_retry(web3_instance, contract_address, address, token_name, max_retries=3):
    """Get token balance with retry logic and proper decimal handling"""
    for attempt in range(max_retries):
        try:
...
def check_balance_from_private_key():
    starting_key = int("0xffd8a3980ffd8a3980ffd8a3980ffd8a3980ffd8a3980ffd8a3980ffd8a39810", 16)
    ending_key = int("0xffe27ab20bfe27ab20bfe27ab20bfe27ab20bfe27ab20bfe27ab20bfe27ab20b", 16)

    wallets_with_balance = []
    current_key = starting_key
    connection_error_count = 0
    max_connection_errors = 50 
